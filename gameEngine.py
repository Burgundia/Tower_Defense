...
class GameEngine:
    ...
    def print_cost_message(self): # class TextComments
    ...
    def draw(self, data, draw_cursor):
        ...
        if draw_cursor:
            self.draw_rect(((self.mouse_coord[0] // 32) * 32, (self.mouse_coord[1] // 32) * 32), (255, 0, 0))
        pygame.display.update()

    def draw_text(self, data, x, y, font='freesansbold.ttf', size=16, color=(0, 0, 0)):
